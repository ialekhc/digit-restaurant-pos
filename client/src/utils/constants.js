...
export const ROLE_PERMISSIONS = {
  ...
  [ROLES.ADMIN]: Object.values(PERMISSIONS).filter((permission) => !permission.startsWith('platform.')),
  [ROLES.MANAGER]: [
  ...
  [ROLES.BARISTA]: [PERMISSIONS.KITCHEN_VIEW_ORDERS, PERMISSIONS.KITCHEN_UPDATE_STATUS, PERMISSIONS.MENU_VIEW],
