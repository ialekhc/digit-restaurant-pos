...
const Topbar = ({ onMenu, user, onLogout }) => {
  ...
  return (
    <header className="sticky top-0 z-10 flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 bg-white/95 px-3 py-2.5 backdrop-blur sm:px-4 lg:px-6">
