...
import { createPayment, getPaymentById, getPayments, settleCreditPayment } from '../controllers/paymentController.js';
...
router.patch('/:id/settle', requirePermission(PERMISSIONS.PAYMENT_COLLECT), settleCreditPayment);
